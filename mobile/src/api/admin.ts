...
export const updateTenantInfo = (data: TenantInfoUpdateRequest): Promise<TenantInfoResponse> =>
  put('/admin/tenant_info', data);
...
export const checkEndOfDayWrites = (checkDate: string) =>
  get(`/admin/check_end_of_day_writes?check_date=${encodeURIComponent(checkDate)}`);

// Roles & Permissions
export const getRolesWithPermissions = (): Promise<RoleWithPermissions[]> =>
...
export const updateEmployee = (employeeId: string | number, data: any): Promise<Employee> =>
