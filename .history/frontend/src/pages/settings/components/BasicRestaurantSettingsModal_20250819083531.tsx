...
export default function BasicRestaurantSettingsModal({ visible, formData, onChange, onClose, onSave, saving, onExited, errors = {} }: Props) {
  ...
  return (
  <Dialog open={visible} onClose={onClose} fullWidth maxWidth="sm" aria-labelledby="restaurant-settings-dialog-title">
      ...
      <DialogContent dividers>
        <Box component="form" noValidate autoComplete="off" sx={{ mt: 1 }}>
          ...
          <Box mt={2}>
            ...
            <TagInput value={formData.sales_channels ?? []} onChange={(val: any) => onChange("sales_channels", val)} placeholder="Add sales channels..." />
