...
import { TenantInfoBasic, SystemHealthBasic, RolesPermissionsBasic, UserManagementBasic, SystemAlertsBasic } from '../pages/admin/components';
...
const routeComponents: Record<string, React.ComponentType<any>> = {
  ...
  'admin_system-alerts': SystemAlertsBasic,
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown:false }}>
      {Object.entries(routeComponents).map(([name, Comp]) => {
        ...
        if (requiredPerm && (!permissions || !permissions.includes(requiredPerm))) return null;
