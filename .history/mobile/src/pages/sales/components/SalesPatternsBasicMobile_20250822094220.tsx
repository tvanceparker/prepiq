...
export default function SalesPatternsBasicMobile() {
  ...
  if (top.length === 0) return <Text style={{ color: theme.colors.onSurfaceVariant }}>No data</Text>;
  ...
  if (list.length === 0) return <Text style={{ color: theme.colors.onSurfaceVariant }}>No data</Text>;
