              ...
              <View style={{ flexDirection: 'row' }}>
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    paddingHorizontal: 10,
                    borderRadius: 16,
                    backgroundColor: !showTreemap ? theme.colors.primary : theme.colors.surfaceVariant,
                    marginRight: 8,
                  }}
                >
                  <Text
                    style={{ color: !showTreemap ? theme.colors.onPrimary : theme.colors.onSurface, fontSize: 12 }}
                  >
                    Pie
                  </Text>
                </TouchableOpacity>
                    ...
                    {aggregatedBreakdown.slice(0, 12).map((b: any, i: number) => (
                      ...
                      >
                        ...
                        <Text style={{ fontWeight: '600' }}>
                          {byRevenue
                            ? `$${Number(b.metric).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`
          ...
          <View style={{ backgroundColor: theme.colors.surface, padding: 12, borderRadius: 12 }}>
            ...
            >
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                >
                  <Text style={{ color: topView ? theme.colors.onPrimary : theme.colors.onSurface, fontSize: 12 }}>
                    Top
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                ...
                >
                  <Text style={{ color: !topView ? theme.colors.onPrimary : theme.colors.onSurface, fontSize: 12 }}>Bottom</Text>
                </TouchableOpacity>
                <TouchableOpacity
