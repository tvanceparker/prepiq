...
export default function SalesExplorerBasicMobile() {
  ...
  return (
    ...
    >
      ...
      <Modal visible={!!editRow} animationType="slide" transparent={Platform.OS === 'ios' ? true : false}>
            ...
            {form && (
              <>
                ...
                <TextInput
                  ...
                  onChangeText={t => setForm((f: any) => ({ ...f, quantity_sold: Number(t) || 0 }))}
                  style={ti}
                ...
                <TextInput
                  ...
                  onChangeText={t => setForm((f: any) => ({ ...f, sales_channel: t }))}
                  style={ti}
                />
                <TextInput
                  placeholder="Revenue"
                  value={String(form.revenue)}
                  onChangeText={t => setForm((f: any) => ({ ...f, revenue: Number(t) || 0 }))}
                  style={ti}
                  keyboardType="numeric"
                />
