...
export default function SalesPatternsBasicMobile() {
  ...
  const charts = [
    ...
    },
    {
      ...
      component: (
        <MiniList data={weekdayAvg} primaryKey="weekday" valueKey="metric" />
      ),
    },
    {
  ...
  return (
    <ScrollView contentContainerStyle={{ padding: 16 }}>
      ...
      <View style={{ flexDirection: "row", marginBottom: 12 }}>
        ...
        />
        <Toggle
          label={layoutMode === "grid" ? "Grid" : "Single"}
          active
          onPress={() =>
            setLayoutMode(layoutMode === "grid" ? "single" : "grid")
          }
        />
      </View>
...
function MiniList({
  ...
  if (!data || data.length === 0)
    return <Text style={{ fontSize: 12, color: "#555" }}>No data</Text>;
  return (
    <View>
