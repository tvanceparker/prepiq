...
export default function SalesPatternsBasicMobile() {
  ...
  // If a refresh helper is available from the hook, call it on mount to ensure a fetch
  useEffect(() => {
    if (typeof (useSalesPatterns as any) === "function") {
      // noop - keep eslint happy, actual refresh comes from hook return
    }
  }, []);
