...
export default function SalesExplorerBasicMobile() {
  ...
  const [channelMenuPosition, setChannelMenuPosition] = useState<{ x: number; y: number } | null>(null);
  ...
  return (
    ...
    >
          ...
          <View style={{ width: '100%', maxWidth: 420, backgroundColor: 'white', padding: 12, borderRadius: 10 }}>
            ...
            {form && (
              <>
                ...
                >
                  {form.sales_channel || 'Select Channel'}
                </Button>
      ...
      <Portal>
        {channelMenuVisible && (
          <View style={{ position: 'absolute', left: 20, right: 20, bottom: 120, backgroundColor: 'white', borderRadius: 8, padding: 8, elevation: 8 }}>
