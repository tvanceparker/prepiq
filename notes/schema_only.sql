...
--
-- Host: 127.0.0.1    Database: prepiq
-- ------------------------------------------------------
...
CREATE TABLE `batch_recipe_ingredients` (
  `batch_recipe_ingredient_id` int(11) NOT NULL AUTO_INCREMENT,
  `batch_recipe_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`batch_recipe_ingredient_id`),
  KEY `ingredient_id` (`reference_id`),
  KEY `restaurant_id` (`restaurant_id`),
  KEY `idx_batch_recipe_id` (`batch_recipe_id`),
  CONSTRAINT `fk_bri_batch_recipe` FOREIGN KEY (`batch_recipe_id`) REFERENCES `batch_recipes` (`batch_recipe_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_bri_restaurant` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurants` (`restaurant_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5015 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `batch_recipe_ingredients_backup`
--

DROP TABLE IF EXISTS `batch_recipe_ingredients_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `batch_recipe_ingredients_backup` (
  `batch_recipe_id` int(11) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=38465 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `devices` (
  ...
  `fingerprint_hash` varchar(255) DEFAULT NULL COMMENT 'SHA256 hash of device hardware fingerprint',
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `is_active` tinyint(1) DEFAULT 1 COMMENT 'Device is active and can be used for authentication',
  `last_seen_at` timestamp NULL DEFAULT NULL COMMENT 'Last time device made a successful request',
  `biometric_capability` varchar(20) DEFAULT NULL COMMENT 'Biometric capability: none | touch_id | face_id | nfc',
  PRIMARY KEY (`device_id`),
  KEY `idx_devices_restaurant_id` (`restaurant_id`),
  KEY `idx_devices_device_type` (`device_type`),
  KEY `idx_devices_restaurant_active` (`restaurant_id`,`is_active`),
  KEY `idx_devices_restaurant_last_seen` (`restaurant_id`,`last_seen_at`),
  KEY `idx_devices_fingerprint` (`restaurant_id`,`fingerprint_hash`)
...
CREATE TABLE `employees` (
  ...
  `mfa_enabled` tinyint(1) DEFAULT 0 COMMENT 'Whether multi-factor authentication is enabled for this employee',
  `mfa_method` varchar(20) DEFAULT NULL COMMENT 'MFA method: null | totp | sms | biometric',
  ...
  KEY `idx_employees_mfa_enabled` (`restaurant_id`,`mfa_enabled`),
...
) ENGINE=InnoDB AUTO_INCREMENT=44049 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `forecasts` (
  ...
  `model_type_used` varchar(32) DEFAULT NULL,
  `model_source` varchar(32) DEFAULT NULL,
  `model_metadata` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`model_metadata`)),
  `created_at` datetime DEFAULT current_timestamp(),
...
) ENGINE=InnoDB AUTO_INCREMENT=38094 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ingredient_supplier` (
  ...
  `review_period_days` int(11) DEFAULT NULL,
  `order_schedule_type` varchar(32) DEFAULT NULL,
  `allowed_order_days` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`allowed_order_days`)),
  `allowed_delivery_days` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`allowed_delivery_days`)),
  `cadence_source` varchar(16) DEFAULT NULL,
  `cadence_confidence_score` decimal(5,4) DEFAULT NULL,
...
CREATE TABLE `ingredients` (
  ...
  `policy_type` varchar(32) DEFAULT NULL,
  `policy_assignment_mode` varchar(16) DEFAULT NULL,
  `target_service_level` decimal(5,4) DEFAULT NULL,
  `service_level_z` decimal(8,4) DEFAULT NULL,
  `policy_override_reason` text DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
...
--
-- Table structure for table `inventory_deduction_discrepancies`
--

DROP TABLE IF EXISTS `inventory_deduction_discrepancies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `inventory_deduction_discrepancies` (
  ...
  `current_quantity_on_hand` decimal(10,2) NOT NULL DEFAULT 0.00,
  `shortfall_quantity` decimal(10,2) NOT NULL DEFAULT 0.00,
  `reference_type` varchar(50) DEFAULT NULL,
  `reference_id` int(11) DEFAULT NULL,
  `attempted_day` date DEFAULT NULL,
  ...
  CONSTRAINT `fk_inventory_deduction_discrepancies_alert` FOREIGN KEY (`alert_id`) REFERENCES `alerts` (`alert_id`),
  CONSTRAINT `fk_inventory_deduction_discrepancies_batch_recipe` FOREIGN KEY (`batch_recipe_id`) REFERENCES `batch_recipes` (`batch_recipe_id`),
  CONSTRAINT `fk_inventory_deduction_discrepancies_ingredient` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredients` (`ingredient_id`),
  CONSTRAINT `fk_inventory_deduction_discrepancies_restaurant` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurants` (`restaurant_id`)
...
CREATE TABLE `inventory_usage_log` (
  ...
  `usage_type` enum('sale','waste','spoilage','manual_adjustment','batch_production','batch_output') NOT NULL,
  `reference_type` enum('sale','batch','user','lot','waste_report','eod_sales','other') DEFAULT NULL,
  `reference_id` int(11) DEFAULT NULL,
  `notes` text DEFAULT NULL,
  PRIMARY KEY (`usage_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5204 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5109 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5084 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recipe_ingredients` (
  ...
  `unit` varchar(20) DEFAULT NULL,
  `ingredient_type` enum('ingredient','batch','recipe') NOT NULL DEFAULT 'ingredient',
  `reference_id` int(11) NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5127 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recipe_ingredients_backup` (
  `recipe_ingredient_id` int(11) NOT NULL DEFAULT 0,
  `recipe_id` int(11) NOT NULL,
  `restaurant_id` int(11) NOT NULL,
  `quantity_used` decimal(10,2) NOT NULL,
  `unit` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ingredient_type` enum('ingredient','batch') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'ingredient',
  `reference_id` int(11) NOT NULL,
  `fallback_ingredient_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=195363 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2901 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
