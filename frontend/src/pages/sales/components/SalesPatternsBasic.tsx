...
export default function SalesPatternsBasic() {
  ...
  const charts = [
    ...
    {
      title: 'Sales Heatmap',
      component: <SalesHeatmap data={heatmapData} />,
    },
    {
  ...
  return (
    ...
    >
      ...
      >
        <ButtonGroup variant="outlined" color="primary" aria-label="layout toggle">
          <MuiButton
      ...
      {!loading && !error && (
        <Box
          sx={{
            display: 'grid',
            gridTemplateColumns: layoutMode === 'grid' ? { xs: '1fr', md: '1fr 1fr' } : '1fr',
            gap: 4,
            width: '100%',
