...
export default function AlertsFeedBasic() {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {viewAll
              ? "Viewing all alerts (active and resolved)"
              : "Showing only active alerts"}
          </Typography>
