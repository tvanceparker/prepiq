...
export default function BasicOverview({ data }) {
  ...
  const { forecasted_sales_today, top_5_items_today, accuracy_yesterday } =
    data;
      ...
      >
          ...
          <Grid item xs={12} sm={4}>
            <SummaryCard
              ...
              color={getAccuracyColor(
                accuracy_yesterday?.accuracy_percent ?? 0
              )}
              icon={<UploadFileIcon />}
            >
        ...
        >
          ...
          >
            <DateSelector
              ...
              onStartDateChange={(date) =>
                setTemplateDate(date.toISOString().slice(0, 10))
              }
              mode="single"
              disableFuture
            />
          ...
          <Typography
            ...
            align="center"
          >
            Select the date to download the corresponding sales template. After
            filling it out, upload your sales data here.
          </Typography>
        </Paper>
        ...
        <Grid container spacing={2}>
          {top_5_items_today?.map(
            ({ menu_item_id, name, forecasted_quantity }) => {
        ...
        <Grid container spacing={3} justifyContent="center">
          <Grid item xs={12} md={6}>
            ...
            >
              Analyze daily, weekly, and monthly sales trends to improve
              forecasting.
            </HintBox>
          </Grid>
          <Grid item xs={12} md={6}>
            ...
            >
              Review how your forecasts performed and track improvements over
              time.
            </HintBox>
          </Grid>
        </Grid>
