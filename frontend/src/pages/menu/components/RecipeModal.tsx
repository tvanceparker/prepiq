...
export default function RecipeModal({
  ...
  const updateIngredient = (index, field, value) => {
    setFormData(prev => {
      ...
      if (field === 'name') {
        ...
        const foundBatch = allBatchRecipes.find(b => b.name.toLowerCase() === value.toLowerCase());
  ...
  return (
    <Dialog open={visible} onClose={onClose} fullWidth maxWidth="md" TransitionProps={{ onExited }}>
          ...
          {(formData.ingredients || []).map((ing, idx) => (
            ...
            >
              <Autocomplete
                ...
                value={ing.name || ''}
                onInputChange={(e, newVal) => updateIngredient(idx, 'name', newVal)}
                renderInput={params => (
      ...
      <DialogActions>
        ...
        <Button onClick={onSave} variant="contained" disabled={!formData.recipe_name?.trim()}>
          Save
        </Button>
      </DialogActions>
    </Dialog>
