...
export default function ProRestaurantSettingsModal({
  visible,
  formData,
  onChange,
  onClose,
          ...
          <TextField
            ...
            helperText={
              ...
              (formData.inventory_deduction_mode === 'real_time'
                ? 'Real-time mode deducts inventory when each order completes (Full tier).'
                : 'EOD mode deducts inventory during the nightly end-of-day job.')
            }
            margin="normal"
          >
            <MenuItem value="eod">End of Day (default)</MenuItem>
            <MenuItem value="real_time">Real-time (requires Full tier)</MenuItem>
          </TextField>
