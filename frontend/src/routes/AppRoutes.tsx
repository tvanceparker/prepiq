  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        ...
        {/* Analytics */}
        <Route path="/analytics/ingredient-trends" element={<IngredientTrends />} />
        <Route path="/analytics/dish-profitability" element={<DishProfitability />} />
